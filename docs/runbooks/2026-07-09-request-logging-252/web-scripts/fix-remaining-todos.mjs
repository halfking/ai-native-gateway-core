...
/**
 * fix-remaining-todos.mjs — 修复剩余的 TODO 标记
 *
 * 这个脚本专门处理 providerDetail.ts 等文件中剩余的 TODO 标记
 * 这些 TODO 标记是在嵌套结构内部的，但父对象是空的
 */
...
function main() {
  ...
  console.log('fix-remaining-todos: 修复剩余的 TODO 标记')
