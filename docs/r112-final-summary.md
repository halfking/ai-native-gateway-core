...
curl -s http://154.host:8781/api/auth/token -X POST -H "Content-Type: application/json" -d '{"username":"admin","password":"<ADMIN_PASSWORD>"}' | jq .
```
