...
GATES = {
    ...
    "S05_quality_penalty": {"succ_pct": 97, "p99_ms": 2500, "label": "延迟/质量降权"},
    "S06_mixed_fault": {"succ_pct": 94, "p99_ms": 2500, "label": "混合故障韧性"},
    ...
    "S12_comprehensive": {"succ_pct": 98, "p99_ms": 2500, "label": "全场景综合压测"},
    "S12_post_recovery": {
        "succ_pct": 98,
        "p99_ms": 2500,
        "label": "全场景综合压测 (恢复)",
...
def evaluate(scenario_key: str, m: dict) -> dict:
