...
go build ./...
go vet ./...
go test -race -timeout 60s ./tests/48h-audit/D14-security/...
```

## 7. 与方案文档的对齐

- RFC：docs/...
- 上轮挂账：docs/audit/playbook/runs/R55-.../agent-D14.md

## 子代理派发提示词

```
你是 worker 子代理（带写权限到 tests/48h-audit/D14-security/）。
知识库入口：docs/audit/playbook/domains/D14-security.md
