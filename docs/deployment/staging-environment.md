...
**说明**: 数据库不在 154 本机，而是内网地址 <env:HOST_252_INTERNAL_IP>（可能是专用 DB 节点）。
...
### 回填单个会话
```bash
export DSN='postgres://llm_gateway:***REDACTED***@<env:HOST_252_INTERNAL_IP>:5432/llm_gateway?sslmode=disable'
