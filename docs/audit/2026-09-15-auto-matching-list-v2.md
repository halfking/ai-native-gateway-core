...
5. **[N5 kimi-k3 通道面]** 当日 7 通道集体退避(429/timeout/403 混合)。**是否将
   ...
   自动规避),仅观察。**
   > **三轮核查(2026-09-16)**:7 通道(#3/#4/#29/#45/#49/#50/#58)绑定 available
   > 已全部自愈为 true,但 node_probe_runs 48h 实测分化 —— #50 9/23(39%)、
   > #49 6/28(21%)、#3 2/11 偶通,#4/#29/#45/#58 探测全败。定性**部分恢复**:
   > #50/#49 列 1M 长上下文观察候选(周观察,成功率连续一周 >50% 可提请升级
   > 备选),其余维持门控观察。明细见 [round3 观测报告](2026-09-16-auto-matching-round3-observation.md) §五。
6. **[N6 claude-5 成本透明度]** claude-sonnet-5/opus-5@suyun#39/#38、apinext#61、
   ...
   > **三轮核查(2026-09-16)**:生产 credential_model_bindings ⋈ provider_models
   > 实测,suyun#39 / apinext#61 / 智码#35 共 16 行 claude 系绑定的
   > unit_price_in/out_per_1m 及 pricing_source/pricing_updated_at **仍全部为空**
   > ——运营补录尚未发生,G4 重跑前置不满足。**补录前成本不可验证标注**(生效):
   > 该三通道 Claude-5 不参与 G4 成本均衡判定,G4"top-3 窗口零>10 分偏差"结论
   > 继续以无单价通道排除为边界。核查明细见
   > [round3 观测报告](2026-09-16-auto-matching-round3-observation.md) §三。
