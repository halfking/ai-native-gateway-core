...
| 环境 | IP | 端口 | 版本 | 解密冒烟 | 状态 |
|---|---|---|---|---|---|
| 154 | <env:HOST_154_IP> | 8782 | 2.4.7-3c51c2e3-1942 | providers=18,1,587 total=15 failed=0 | ✅ active |
| 245 | <env:HOST_245_IP> | 8781 | 2.5.0-f6ea47da-1945 | providers=18,1,587 total=15 failed=0 | ✅ running |
...
```bash
ssh -p 25022 root@<env:HOST_154_IP> "ENV_FILE=/etc/llm-gateway-go/env BASE=http://127.0.0.1:8782 python3 -" < decrypt_smoke.py
ssh -p 25022 root@<env:HOST_245_IP> "ENV_FILE=/opt/llm-gateway-go/.env BASE=http://127.0.0.1:8781 python3 -" < decrypt_smoke.py
```
