...
上表为 2026-09 初版 9 步快照；656 之后新增的补丁修订（725…743，含 727/728/729/730/731/733/734/738/740/742/743 等；R61 清扫勘误补 743）已登记在 `scripts/apply-db-revision-sequence.sh` 内清单，以脚本为准，本表不再逐项追踪。
