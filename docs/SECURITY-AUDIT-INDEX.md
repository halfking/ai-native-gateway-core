...
|---------|------|------|------|------------|------|
| [`SECURITY-AUDIT-2026-06-28`](../SECURITY-AUDIT-2026-06-28.md) | 2026-06-28 | 网络/传输层 | HTTP/CORS/Headers/暴露面/Slowloris/XFF | P0/P1/P2 | **11 项书面化 + 10/11 动态验证命中 + 7 项已修复（v1.3）** |
