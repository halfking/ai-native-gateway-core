...
# 检查 PG 状态
PGPASSWORD="***REDACTED***" pg_isready \
...
# 4. 验证
PGPASSWORD="***REDACTED***" psql -h 192.168.31.8 -p 30432 -U llm_gateway -d llm_gateway -c "SELECT count(*) FROM pg_tables WHERE schemaname='public';"
