...
# The shared helper writes a strict SKIPPED envelope. The parent strict runner
# treats it as incomplete unless the caller explicitly requests --allow-skipped.
