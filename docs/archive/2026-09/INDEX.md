...
>
> 🗄️ 本文件为 2026-09-07 时点 `docs/INDEX.md` 的归档快照（commit 5a9192156 移入 archive），文中链接已改写为相对本档案位置指向 `docs/` 目录；现行文档以 [docs/README.md](../../README.md) 与仓库根 [README.md](../../../README.md) 为准。
