---
archived_from: docs/2026-07-09-unified-tagging-redaction-summary.md
...
- [ ] admin 登录（`admin / __REDACTED_SSH_PASSWORD__`）
- [ ] 登录后验证设置页与会话详情页
...
- 因此，浏览器侧无法完成 `admin / __REDACTED_SSH_PASSWORD__` 登录，也就无法继续验证登录后页面（设置页、会话详情页）
