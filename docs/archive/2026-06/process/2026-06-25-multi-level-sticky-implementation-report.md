---
archived_from: docs/2026-06-25-multi-level-sticky-implementation-report.md
...
用户报告的现象：
1. 手工选择 `claude-opus-4-8` (__USER_2__组第3个)
2. 实际使用了 `minimax-m2.7-quickspeed` (__USER_2__组第2个)
3. 两次失败后才用上正确的模型
...
```bash
# 检查健康
curl -s https://__DOMAIN_8__/healthz
