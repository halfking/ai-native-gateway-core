---
archived_from: docs/2026-06-21-three-day-audit.md
...
| 联动 | 状态 | 审计点 |
|------|------|--------|
| ACC → llm-gateway-go (`X-Gw-Session-Id`) | `5012ef0e` 已部署 | 184 nginx acc.__DOMAIN_12__ → ACC → gateway e2e 验证 |
...
8cc5b8d7  18:??:??  fix(docker): chown __SERVER_PATH_1__ to appuser
```
