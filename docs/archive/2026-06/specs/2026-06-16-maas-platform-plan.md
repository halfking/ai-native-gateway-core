---
archived_from: docs/2026-06-16-maas-platform-plan.md
...
- 生产：`https://__DOMAIN_8__`（184 k3s，`k8s/apps/llm-gateway-go.yaml`）
...
6. **部署**：184 滚动后 `https://__DOMAIN_8__/healthz` 200
