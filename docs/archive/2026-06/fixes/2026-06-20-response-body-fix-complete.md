---
archived_from: docs/2026-06-20-response-body-fix-complete.md
...
```bash
# 构建镜像
docker build -t __DOMAIN_9__/kx-llm-gateway-go:fix-response-body .

# 推送镜像
docker push __DOMAIN_9__/kx-llm-gateway-go:fix-response-body

# 更新 k8s deployment
kubectl -n pms-test set image deployment/llm-gateway-go-deployment \
  llm-gateway-go=__DOMAIN_9__/kx-llm-gateway-go:fix-response-body
