...
详见 [LOCAL_DEPLOYMENT_TEST_GUIDE.md 第 5 章](./LOCAL_DEPLOYMENT_TEST_GUIDE.md#5-测试场景)
...
详见 [LOCAL_DEPLOYMENT_TEST_GUIDE.md 第 6 章](./LOCAL_DEPLOYMENT_TEST_GUIDE.md#6-故障排查)
...
1. 查看 [故障排查](./LOCAL_DEPLOYMENT_TEST_GUIDE.md#6-故障排查)
