# 2026-09-12 request_logs 冷迁移停滞修复——claim 守卫接线根除 + promote 自愈（迁移 694）
...
2. **promote 自愈**（`sql/migrations/startup/694_request_logs_promote_final_success_self_heal.sql`）
   ...
   - `migration_694_test.go` 形状断言钉住三列清单一致与 demote 谓词范围。
