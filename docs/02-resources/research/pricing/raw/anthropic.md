...
*   [Messages](https://docs.anthropic.com/docs/en/intro)
...
[API reference](https://docs.anthropic.com/docs/en/api/overview)English[Console](https://docs.anthropic.com/)[Log in](https://docs.anthropic.com/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fpricing)
...
[Models overview](https://docs.anthropic.com/docs/en/about-claude/models/overview)[Model IDs and versioning](https://docs.anthropic.com/docs/en/about-claude/models/model-ids-and-versions)[Choosing a model](https://docs.anthropic.com/docs/en/about-claude/models/choosing-a-model)[Introducing Claude Fable 5 and Claude Mythos 5](https://docs.anthropic.com/docs/en/about-claude/models/introducing-claude-fable-5-and-claude-mythos-5)[What's new in Claude Opus 4.8](https://docs.anthropic.com/docs/en/about-claude/models/whats-new-claude-4-8)[Upgrade between model versions](https://docs.anthropic.com/docs/en/about-claude/models/migration-guide)[Model deprecations](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)[Model cards](https://docs.anthropic.com/docs/en/resources/overview)[System prompts](https://docs.anthropic.com/docs/en/release-notes/system-prompts)[Pricing](https://docs.anthropic.com/docs/en/about-claude/pricing)
...
| Claude Opus 4.1 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $15 / MTok | $18.75 / MTok | $30 / MTok | $1.50 / MTok | $75 / MTok |
| Claude Opus 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $15 / MTok | $18.75 / MTok | $30 / MTok | $1.50 / MTok | $75 / MTok |
| Claude Sonnet 4.6 | $3 / MTok | $3.75 / MTok | $6 / MTok | $0.30 / MTok | $15 / MTok |
| Claude Sonnet 4.5 | $3 / MTok | $3.75 / MTok | $6 / MTok | $0.30 / MTok | $15 / MTok |
| Claude Sonnet 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $3 / MTok | $3.75 / MTok | $6 / MTok | $0.30 / MTok | $15 / MTok |
| Claude Haiku 4.5 | $1 / MTok | $1.25 / MTok | $2 / MTok | $0.10 / MTok | $5 / MTok |
| Claude Haiku 3.5 ([retired, except on Bedrock and Vertex AI](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $0.80 / MTok | $1 / MTok | $1.60 / MTok | $0.08 / MTok | $4 / MTok |



MTok = Million tokens. The "Base Input Tokens" column shows standard input pricing, the "5m Cache Writes", "1h Cache Writes", and "Cache Hits & Refreshes" columns are specific to [prompt caching](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching), and "Output Tokens" shows output pricing. See [prompt caching pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching) for an explanation of the cache columns and pricing multipliers.
...
For Claude Platform on AWS pricing, see [Claude Platform on AWS pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#claude-platform-on-aws-pricing).

## 

Cloud platform pricing

This section covers partner-operated cloud platforms, where the cloud provider invoices you. For Anthropic-operated cloud platforms billed through a marketplace, see [Claude Platform on AWS pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#claude-platform-on-aws-pricing) and [Claude in Microsoft Foundry](https://docs.anthropic.com/docs/en/build-with-claude/claude-in-microsoft-foundry).

Claude models are available on [Amazon Bedrock](https://docs.anthropic.com/docs/en/build-with-claude/claude-in-amazon-bedrock) and [Vertex AI](https://docs.anthropic.com/docs/en/build-with-claude/claude-on-vertex-ai). For official pricing, visit:
...
Regional and multi-region endpoints include a 10% premium over global endpoints. The Claude API (first-party) is global by default; for first-party data residency options and pricing, see [Data residency pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#data-residency-pricing).
...
*   [Amazon Bedrock global vs regional endpoints](https://docs.anthropic.com/docs/en/build-with-claude/claude-in-amazon-bedrock#regions) for Opus 4.7, Haiku 4.5, and later models, or [the legacy integration](https://docs.anthropic.com/docs/en/build-with-claude/claude-on-amazon-bedrock-legacy#global-vs-regional-endpoints) for all other models on Bedrock
*   [Vertex AI global, multi-region, and regional endpoints](https://docs.anthropic.com/docs/en/build-with-claude/claude-on-vertex-ai#global-multi-region-and-regional-endpoints)
...
| **Conversion** | Token usage rated in USD at standard per-model, per-feature rates (same as [Claude API pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#model-pricing)), then converted to CCUs at $0.01 per CCU |
...
For Claude Opus 4.6, Claude Sonnet 4.6, and later models, using `inference_geo: "us"` applies a 1.1x pricing multiplier. `inference_geo: "global"` (default) uses standard pricing. See [Data residency](https://docs.anthropic.com/docs/en/manage-claude/data-residency) for details.
...
For implementation details, supported models, and code examples, see [Prompt caching](https://docs.anthropic.com/docs/en/build-with-claude/prompt-caching).
...
For more information, see [Data residency](https://docs.anthropic.com/docs/en/manage-claude/data-residency).
...
*   [Prompt caching multipliers](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching) apply on top of fast mode pricing
*   [Data residency](https://docs.anthropic.com/docs/en/manage-claude/data-residency) multipliers apply on top of fast mode pricing

Fast mode is not available with the [Batch API](https://docs.anthropic.com/en/docs/about-claude/pricing#batch-processing).

For more information, see [Fast mode](https://docs.anthropic.com/docs/en/build-with-claude/fast-mode).
...
| Claude Opus 4.1 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $7.50 / MTok | $37.50 / MTok |
| Claude Opus 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $7.50 / MTok | $37.50 / MTok |
| Claude Sonnet 4.6 | $1.50 / MTok | $7.50 / MTok |
| Claude Sonnet 4.5 | $1.50 / MTok | $7.50 / MTok |
| Claude Sonnet 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $1.50 / MTok | $7.50 / MTok |
| Claude Haiku 4.5 | $0.50 / MTok | $2.50 / MTok |
| Claude Haiku 3.5 ([retired, except on Bedrock and Vertex AI](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | $0.40 / MTok | $2 / MTok |

For more information about batch processing, see [Batch processing](https://docs.anthropic.com/docs/en/build-with-claude/batch-processing).

### 

Long context pricing

Claude Fable 5, [Claude Mythos 5](https://anthropic.com/glasswing), [Claude Mythos Preview](https://anthropic.com/glasswing), Claude Opus 4.8, Opus 4.7, Opus 4.6, and Sonnet 4.6 include the full [1M token context window](https://docs.anthropic.com/docs/en/build-with-claude/context-windows) at standard pricing. (A 900k-token request is billed at the same per-token rate as a 9k-token request.) Prompt caching and batch processing discounts apply at standard rates across the full context window.
...
| Claude Opus 4.1 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | `auto`, `none` * * * `any`, `tool` | 313 tokens * * * 315 tokens |
| Claude Opus 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | `auto`, `none` * * * `any`, `tool` | 313 tokens * * * 315 tokens |
| Claude Sonnet 4.6 | `auto`, `none` * * * `any`, `tool` | 497 tokens * * * 589 tokens |
| Claude Sonnet 4.5 | `auto`, `none` * * * `any`, `tool` | 496 tokens * * * 588 tokens |
| Claude Sonnet 4 ([deprecated](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | `auto`, `none` * * * `any`, `tool` | 313 tokens * * * 315 tokens |
| Claude Haiku 4.5 | `auto`, `none` * * * `any`, `tool` | 496 tokens * * * 588 tokens |
| Claude Haiku 3.5 ([retired, except on Bedrock and Vertex AI](https://docs.anthropic.com/docs/en/about-claude/model-deprecations)) | `auto`, `none` * * * `any`, `tool` | 264 tokens * * * 355 tokens |

These token counts are added to your normal input and output tokens to calculate the total cost of a request.

For current per-model prices, refer to the [model pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#model-pricing) section.

For more information about tool use implementation and best practices, see [Tool use](https://docs.anthropic.com/docs/en/agents-and-tools/tool-use/overview).
...
See [tool use pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#tool-use-pricing) for complete pricing details.
...
Computer use follows the standard [tool use pricing](https://docs.anthropic.com/docs/en/agents-and-tools/tool-use/overview#pricing). When using the computer use tool:
...
*   Screenshot images (see [Vision pricing](https://docs.anthropic.com/docs/en/build-with-claude/vision))
...
[Claude Managed Agents](https://docs.anthropic.com/docs/en/managed-agents/overview) is billed on two dimensions: tokens and session runtime.

### 

Tokens

All tokens consumed by a Claude Managed Agents session are billed at the rates shown in [Model pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#model-pricing). [Prompt caching](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching) multipliers apply identically. Web search triggered inside a session incurs the standard $10 per 1,000 searches. On [Claude Platform on AWS](https://docs.anthropic.com/en/docs/about-claude/pricing#claude-platform-on-aws-pricing), session token and runtime charges convert to Claude Consumption Units at the standard rate.

The following Messages API modifiers do **not** apply to Claude Managed Agents sessions:

| Modifier | Why it doesn't apply |
| --- | --- |
| [Batch API discount](https://docs.anthropic.com/en/docs/about-claude/pricing#batch-processing) | Sessions are stateful and interactive. There is no batch mode. |
| [Fast mode premium](https://docs.anthropic.com/en/docs/about-claude/pricing#fast-mode-pricing) | Inference speed is managed by the runtime. |
| [Data residency multiplier](https://docs.anthropic.com/en/docs/about-claude/pricing#data-residency-pricing) | `inference_geo` is a Messages API request field. |
| [Cloud platform pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#cloud-platform-pricing) | Not available on partner-operated cloud platforms. |
...
Session runtime replaces the [Code Execution](https://docs.anthropic.com/en/docs/about-claude/pricing#code-execution-tool) container-hour billing model when using Claude Managed Agents. You are not separately billed for container hours on top of session runtime.
...
For a detailed walkthrough of this calculation, see the [customer support agent guide](https://docs.anthropic.com/docs/en/about-claude/use-case-guides/customer-support-chat).
...
For detailed rate limit information, see [Rate limits](https://docs.anthropic.com/docs/en/api/rate-limits).
...
*   Standard tiers use the pricing shown in [Model pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#model-pricing)
*   Enterprise customers can [contact sales](https://docs.anthropic.com/cdn-cgi/l/email-protection#deadbfb2bbad9ebfb0aab6acb1aeb7bdf0bdb1b3) for custom pricing
...
Contact the sales team at [[email protected]](https://docs.anthropic.com/cdn-cgi/l/email-protection#74071518110734151a001c061b041d175a171b19) or through the [Claude Console](https://docs.anthropic.com/settings/limits) to discuss enterprise pricing options.
...
*   Usage tracking available in the [Claude Console](https://docs.anthropic.com/)
...
New users receive a small amount of free credits to test the API. [Contact sales](https://docs.anthropic.com/cdn-cgi/l/email-protection#fe8d9f929b8dbe9f908a968c918e979dd09d9193) for information about extended trials for enterprise evaluation.

**How do discounts stack?**

Batch API and prompt caching discounts can be combined. For example, using both features together provides significant cost savings compared to standard API calls. See [prompt caching pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching) for how the multipliers interact.
...
For additional questions about pricing, contact [[email protected]](https://docs.anthropic.com/cdn-cgi/l/email-protection#c7b4b2b7b7a8b5b387a6a9b3afb5a8b7aea4e9a4a8aa).
...
*   [Cloud platform pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#cloud-platform-pricing)
*   [Claude Platform on AWS pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#claude-platform-on-aws-pricing)
*   [Inference geography](https://docs.anthropic.com/en/docs/about-claude/pricing#inference-geography)
*   [Private offers](https://docs.anthropic.com/en/docs/about-claude/pricing#private-offers)
*   [Feature-specific pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#feature-specific-pricing)
*   [Prompt caching](https://docs.anthropic.com/en/docs/about-claude/pricing#prompt-caching)
*   [Data residency pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#data-residency-pricing)
*   [Fast mode pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#fast-mode-pricing)
*   [Batch processing](https://docs.anthropic.com/en/docs/about-claude/pricing#batch-processing)
*   [Long context pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#long-context-pricing)
*   [Tool use pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#tool-use-pricing)
*   [Specific tool pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#specific-tool-pricing)
*   [Claude Managed Agents pricing](https://docs.anthropic.com/en/docs/about-claude/pricing#claude-managed-agents-pricing)
*   [Tokens](https://docs.anthropic.com/en/docs/about-claude/pricing#tokens)
*   [Session runtime](https://docs.anthropic.com/en/docs/about-claude/pricing#session-runtime)
*   [Worked example](https://docs.anthropic.com/en/docs/about-claude/pricing#worked-example)
