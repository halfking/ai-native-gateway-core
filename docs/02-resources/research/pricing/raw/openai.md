...
[Apps SDK Build apps to extend ChatGPT](https://platform.openai.com/apps-sdk)[Workspace Agents Trigger published ChatGPT workspace agents](https://platform.openai.com/workspace-agents)[Commerce Build commerce flows in ChatGPT](https://platform.openai.com/commerce)[Ads Publish and measure ads in ChatGPT](https://platform.openai.com/ads)
...
[SDKs and CLI](https://platform.openai.com/api/docs/libraries)
    ...
    *   [OpenAI CLI](https://platform.openai.com/api/docs/libraries/openai-cli)

*   [Latest: GPT-5.5](https://platform.openai.com/api/docs/guides/latest-model)
...
*   [Red teaming](https://platform.openai.com/api/docs/guides/red-teaming)
...
Realtime sessions
    ...
    *   [Realtime with tools](https://platform.openai.com/api/docs/guides/realtime-mcp)
...
[Workload identity federation](https://platform.openai.com/api/docs/guides/workload-identity-federation)
    ...
    *   [AWS](https://platform.openai.com/api/docs/guides/workload-identity-federation/aws)
    *   [Microsoft Azure](https://platform.openai.com/api/docs/guides/workload-identity-federation/microsoft-azure)
    *   [Google Cloud](https://platform.openai.com/api/docs/guides/workload-identity-federation/google-cloud)
    *   [GitHub Actions](https://platform.openai.com/api/docs/guides/workload-identity-federation/github-actions)
    *   [SPIFFE](https://platform.openai.com/api/docs/guides/workload-identity-federation/spiffe)
...
*   [IP egress ranges](https://platform.openai.com/api/docs/guides/ip-addresses)
*   [Admin APIs](https://platform.openai.com/api/docs/guides/admin-apis)
...
[Sandboxing](https://platform.openai.com/codex/concepts/sandboxing)
    ...
    *   [Glossary](https://platform.openai.com/codex/glossary)
...
App
    ...
    *   [Chrome extension](https://platform.openai.com/codex/app/chrome-extension)
    *   [Computer Use](https://platform.openai.com/codex/app/computer-use)
    *   [Appshots](https://platform.openai.com/codex/appshots)
...
Config File
    ...
    *   [Environment Variables](https://platform.openai.com/codex/environment-variables)
    *   [Sample Config](https://platform.openai.com/codex/config-sample)

*   [Permissions](https://platform.openai.com/codex/permissions)
...
*   [Sites](https://platform.openai.com/codex/sites)
...
*   [Restaurant reservation spec](https://platform.openai.com/apps-sdk/guides/restaurant-reservation-conversion-spec)
*   [Product checkout spec](https://platform.openai.com/apps-sdk/guides/product-checkout-conversion-spec)
...
*   [Home](https://platform.openai.com/workspace-agents)

### Get started

*   [Trigger workspace agent runs](https://platform.openai.com/workspace-agents/trigger-runs)
*   [Authenticate with Workspace Agent access tokens](https://platform.openai.com/workspace-agents/authentication)
...
*   [Ads Overview](https://platform.openai.com/ads)

### Measurement

*   [JavaScript Pixel](https://platform.openai.com/ads/measurement-pixel)
*   [Conversions API](https://platform.openai.com/ads/conversions-api)
*   [Supported events](https://platform.openai.com/ads/supported-events)

### Advertiser API

*   [Overview](https://platform.openai.com/ads/api-overview)
*   [Quickstart](https://platform.openai.com/ads/api-quickstart)
*   [Campaign Targeting](https://platform.openai.com/ads/campaign-targeting)

### API Reference

*   [Authentication](https://platform.openai.com/ads/api-reference/authentication)
*   [Campaigns](https://platform.openai.com/ads/api-reference/campaigns)
*   [Ad Groups](https://platform.openai.com/ads/api-reference/ad-groups)
*   [Ads](https://platform.openai.com/ads/api-reference/ads)
*   [Ad Account](https://platform.openai.com/ads/api-reference/ad-account)
...
*   [Sites](https://platform.openai.com/showcase/sites)
...
*   [OpenAI Developers plugin](https://platform.openai.com/learn/developers-codex-plugin)
...
If you're not sure where to start, use[GPT-5.5](https://platform.openai.com/api/docs/models/gpt-5.5), our flagship model for complex reasoning and coding. If you're optimizing for latency and cost, choose a smaller variant like[GPT-5.4 mini](https://platform.openai.com/api/docs/models/gpt-5.4-mini)or[GPT-5.4 nano](https://platform.openai.com/api/docs/models/gpt-5.4-nano).

All latest OpenAI models support text and image input, text output, multilingual capabilities, and vision. Models are available via the[Responses API](https://platform.openai.com/api/docs/api-reference/responses)and our [Client SDKs](https://platform.openai.com/api/docs/libraries).
...
[GPT-5.5 New A new class of intelligence for coding and professional work. Model ID gpt-5.5 [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $5 / Input MTok Output price $30 / Output MTok Latency Fast Max output 128K tokens Context window 1M [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, Computer use Knowledge cutoff Dec 1, 2025](https://platform.openai.com/api/docs/models/gpt-5.5)[GPT-5.4 A more affordable model for coding and professional work. Model ID gpt-5.4 [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $2.50 / Input MTok Output price $15 / Output MTok Latency Fast Max output 128K tokens Context window 1M [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, Computer use Knowledge cutoff Aug 31, 2025](https://platform.openai.com/api/docs/models/gpt-5.4)[GPT-5.4 mini Our strongest mini model yet for coding, computer use, and subagents Model ID gpt-5.4-mini [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $0.75 / Input MTok Output price $4.50 / Output MTok Latency Faster Max output 128K tokens Context window 400K [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, Computer use Knowledge cutoff Aug 31, 2025](https://platform.openai.com/api/docs/models/gpt-5.4-mini)
...
[![Image 2: gpt-image-2](https://platform.openai.com/images/api/models/icons/gpt-image-2.png) GPT Image 2 State-of-the-art image generation model](https://platform.openai.com/api/docs/models/gpt-image-2)

Realtime

Models for realtime speech and translation

[![Image 3: gpt-realtime-2](https://platform.openai.com/images/api/models/icons/gpt-realtime-2.png) GPT-Realtime-2 Reasoning model for realtime voice interactions](https://platform.openai.com/api/docs/models/gpt-realtime-2)[![Image 4: gpt-realtime-translate](https://platform.openai.com/images/api/models/icons/gpt-realtime-translate.png) GPT-Realtime-Translate Streaming speech-to-speech translation model](https://platform.openai.com/api/docs/models/gpt-realtime-translate)[![Image 5: gpt-realtime-1.5](https://platform.openai.com/images/api/models/icons/gpt-realtime-1.5.png) GPT-Realtime-1.5 The best voice model for audio in, audio out](https://platform.openai.com/api/docs/models/gpt-realtime-1.5)[![Image 6: gpt-realtime-mini](https://platform.openai.com/images/api/models/icons/gpt-realtime-mini.png) GPT-Realtime mini A cost-efficient version of GPT-Realtime](https://platform.openai.com/api/docs/models/gpt-realtime-mini)

Speech generation

Models for generating natural-sounding speech from text

[![Image 7: gpt-4o-mini-tts](https://platform.openai.com/images/api/models/icons/gpt-4o-mini-tts.png) GPT-4o mini TTS Deprecated Text-to-speech model powered by GPT-4o mini](https://platform.openai.com/api/docs/models/gpt-4o-mini-tts)

Transcription

Models for transcribing speech into text

[![Image 8: gpt-realtime-whisper](https://platform.openai.com/images/api/models/icons/gpt-realtime-whisper.png) GPT-Realtime-Whisper Streaming speech-to-text model for realtime transcription](https://platform.openai.com/api/docs/models/gpt-realtime-whisper)[![Image 9: gpt-4o-transcribe](https://platform.openai.com/images/api/models/icons/gpt-4o-transcribe.png) GPT-4o Transcribe Speech-to-text model powered by GPT-4o](https://platform.openai.com/api/docs/models/gpt-4o-transcribe)[![Image 10: gpt-4o-mini-transcribe](https://platform.openai.com/images/api/models/icons/gpt-4o-mini-transcribe.png) GPT-4o mini Transcribe Speech-to-text model powered by GPT-4o mini](https://platform.openai.com/api/docs/models/gpt-4o-mini-transcribe)

## Browse our full catalog of models

Diverse models for a variety of tasks

View all models Compare models

[How we use your data](https://platform.openai.com/api/docs/guides/your-data)·[Deprecated models](https://platform.openai.com/api/docs/deprecations)
