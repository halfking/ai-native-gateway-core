...
INSERT INTO public.model_families VALUES ('xiaomi-mimo', 'Xiaomi Mimo', 'Xiaomi', 'active', 'derived', NULL, '2026-06-11 16:22:43.670498+00', '2026-06-11 16:22:43.670498+00') ON CONFLICT DO NOTHING;
...
INSERT INTO public.provider_catalog VALUES ('nvidia', 'tier2', 'NVIDIA NIM', 'NVIDIA NIM', 'aggregator', 'cloud', 'openai-completions', 'https://integrate.api.nvidia.com/v1', 'https://docs.api.nvidia.com/nim/reference/llm-apis', 'proxy', false, 1.0000, '[{"id": "z-ai/glm-5.1", "ctx_k": 128, "display_name": "GLM-5.1 (NVIDIA)"}, {"id": "z-ai/glm-5.2", "ctx_k": 128, "display_name": "GLM-5.2 (NVIDIA)"}, {"id": "minimaxai/minimax-m3", "ctx_k": 128, "display_name": "MiniMax M3 (NVIDIA)"}, {"id": "minimaxai/minimax-m2.7", "ctx_k": 245, "display_name": "MiniMax M2.7 (NVIDIA)"}, {"id": "meta/llama-3.3-70b-instruct", "ctx_k": 131, "display_name": "Llama 3.3 70B (NVIDIA)"}, {"id": "nvidia/llama-3.3-nemotron-super-49b-v1.5", "ctx_k": 131, "display_name": "Nemotron Super 49B v1.5"}, {"id": "qwen/qwen3-5-122b-a10b", "ctx_k": 131, "display_name": "Qwen3.5 122B (NVIDIA)"}, {"id": "deepseek-ai/deepseek-v4-flash", "ctx_k": 64, "display_name": "DeepSeek V4 Flash (NVIDIA)"}]', 'auto', '/models', '[]', '{}', false, 'NVIDIA NIM 云端推理，托管多家开源模型，OpenAI 兼容，需海外网络访问', 1, '2026-06-11 16:22:38.602581+00', '2026-06-11 16:22:38.602581+00', 'openai_relay', '{}', 'nvidia') ON CONFLICT DO NOTHING;
