-- Migration 666: training_human_annotations.request_id 唯一索引（P2.1 功能验证 hotfix）
--
-- Bug: 部署 664 后 POST /api/admin/annotations 与 /batch 一律 500：
--   "there is no unique or exclusion constraint matching the ON CONFLICT
--    specification (SQLSTATE 42P10)"
--   664 把 request_id 建成了普通索引（idx_training_human_annotations_
...
--
-- Idempotent: IF NOT EXISTS。664/665 已应用且 checksum 入账，不可原地改。
-- 2026-09-06
