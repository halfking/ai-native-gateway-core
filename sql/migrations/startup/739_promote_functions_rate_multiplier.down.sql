-- ===========================================================================
-- File:          sql/migrations/startup/739_promote_functions_rate_multiplier.down.sql
-- Migration:     739 (down)
-- Database:      llm_gateway
-- Purpose:       反向：恢复 698 原版两个 promote 函数体（不含倍率列）。
--                注意：回滚后热窗转移会继续把倍率证据落 1x/NULL —— 与 736
--                配套锁，必须 736/739 同步回滚才一致。
-- ===========================================================================
