-- Migration 713: session_turns.cost_usd numeric(12,6) → numeric(14,8).
...
VALUES ('713', 'storage plan v2 E5: session_turns.cost_usd numeric(12,6) -> numeric(14,8) aligning request_logs precision; turns view rebuilt in-place, request_logs view by db.ensure')
