-- 417_route_excludes_failed_node_probes.sql
-- Purpose: Make node_probe_state a routing guard for failed direct probes.
-- Idempotent: YES
-- Rollback: Recreate v_routable_credential_models without the node_probe_state
-- predicate after reviewing the affected routing rows.
