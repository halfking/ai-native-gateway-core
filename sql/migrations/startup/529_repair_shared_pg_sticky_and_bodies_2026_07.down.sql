-- Down migration 529: intentionally non-destructive.
--
-- Both repaired objects remain compatible with pre-529 binaries:
...
-- the up migration may have reused an object created outside migration 529.
...
DO $$
BEGIN
    RAISE NOTICE '529 down is a no-op: preserving sticky conflict arbiter and historical audit partition';
END $$;
