...
COMMENT ON COLUMN public.session_turns.attachment_count IS 
  'Number of attachments in this turn (request + response combined)';

COMMENT ON COLUMN public.session_turns.attachment_total_bytes IS 
  'Total bytes of all attachments in this turn';

COMMENT ON COLUMN public.session_turns.multimodal_types IS 
