-- Migration 460 down: Remove periodic_exhausted from v_routable_credential_models
--
-- Reverts to migration 417 state (without periodic_exhausted handling)
--
-- Date: 2026-07-27
...
COMMENT ON VIEW public.v_routable_credential_models IS
    ...
    'Downgrade of migration 460 (2026-07-27).';
