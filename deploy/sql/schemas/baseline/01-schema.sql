...
-- Session turns 524/525 baseline objects.
...
-- Migration 525 owns session_turns_hot, its view, and promotion functions.
-- Keep those startup-managed objects out of the fresh-bootstrap schema.
/* Startup migration 525 definition intentionally not executed here.
...
BEGIN
    ...
    INSERT INTO session_turns_promotion_batch (
        id, partition_date, tenant_id, session_id
    )
    SELECT h.id, h.partition_date, h.tenant_id, h.session_id
