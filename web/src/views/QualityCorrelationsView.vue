...
.qc-table td { padding: 8px 10px; border-bottom: 1px solid var(--bg); }
.tag {
...
.insight-interpretation { font-size: 13px; color: var(--border); margin-bottom: 2px; }
