...
const hotTables = ref<HotTable[]>([
  ...
  {
    name: 'request_wal_hot',
    label: t('dataLifecycle.hotPartition.hotTableNames.requestWal'),
    sizeHuman: '—',
    sizeBytes: 0,
    toastHuman: '—',
    rows: 0,
  ...
  {
    name: 'request_logs_bodies_hot',
    label: t('dataLifecycle.hotPartition.hotTableNames.requestLogsBodies'),
    sizeHuman: '—',
    sizeBytes: 0,
    toastHuman: '—',
    rows: 0,
  ...
  {
    name: 'credit_ledger_hot',
    label: t('dataLifecycle.hotPartition.hotTableNames.creditLedger'),
    sizeHuman: '—',
    sizeBytes: 0,
    toastHuman: '—',
    rows: 0,
  ...
  {
    name: 'tool_usage_stats_hot',
    label: t('dataLifecycle.hotPartition.hotTableNames.toolUsageStats'),
    sizeHuman: '—',
    sizeBytes: 0,
    toastHuman: '—',
    rows: 0,
