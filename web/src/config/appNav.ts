...
// 2026-09-12: 移除废弃的 sidebar 折叠持久化（SIDEBAR_COLLAPSED_KEY /
// readSidebarCollapsed / writeSidebarCollapsed）。topbar 迁移（2026-07-21）
// 后无任何调用方，localStorage key `llmgw_sidebar_collapsed` 随之废弃。
