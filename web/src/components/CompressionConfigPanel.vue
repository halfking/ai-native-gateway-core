...
.compact-select,.compact-input,.compact-number { box-sizing:border-box; width:100%; min-width:0; height:32px; padding:5px 8px; color:var(--text); background:var(--bg); border:1px solid var(--border); border-radius:6px; font:inherit; font-size:12px; }
