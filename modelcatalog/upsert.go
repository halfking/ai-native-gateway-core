...
// Querier is the minimum database surface needed to write canonical models
// and aliases. It permits pgxmock-backed tests without coupling callers to a
// concrete connection pool.
