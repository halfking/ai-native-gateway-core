...
// filtering format noise and deduplicating against existing facts.
...
func isNoise(s string) bool {
	...
	if reCodeFence.MatchString(s) || reToolJSON.MatchString(s) || reSysPrompt.MatchString(s) {
		return true
	}
