...
> 控制台真实运行截图 — 全部部署在 184 k3s 节点生产环境，敏感凭据 / 数字已脱敏。

### 1. 凭据监控 — 多源模型 × 多凭据 的实时健康仪表盘

![凭据监控](docs/screenshots/12-credential-monitor.png)
...
![路由全景](docs/screenshots/13-routing-panorama.png)
...
![请求日志](docs/screenshots/14-request-logs.png)
...
![数据生命周期](docs/screenshots/15-data-lifecycle.png)
...
![租户管理](docs/screenshots/16-tenant-overview.png)
...
![成本价格](docs/screenshots/17-cost-pricing.png)
