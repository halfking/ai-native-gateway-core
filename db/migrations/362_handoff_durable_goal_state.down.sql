-- Migration 362: durable GoalState snapshots for handoff confirmation
-- Down migration intentionally preserves accounting/audit rows; operators may
-- drop the added columns only after disabling durable Goal restore.
BEGIN;
